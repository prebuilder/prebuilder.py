...
knownReleases = OrderedDict((
	(
		"Mint",
		(
			MintRelease((21, 1), (2022, 12, 20), ("vera",)),
			MintRelease((21, 0), (2022, 7, 31), ("vanessa",)),
			MintRelease((20, 3), (2022, 1, 7), ("una",)),
			MintRelease((20, 2), (2021, 7, 8), ("uma",)),
			MintRelease((20, 1), (2021, 1, 8), ("ulyssa",)),
	...
	(
		"Ubuntu",
		(
			UbuntuRelease((22, 10), (2022, 10, 20), ("kinetic",)),
			UbuntuRelease((22, 4), (2022, 4, 21), ("jammy",)),
			UbuntuRelease((21, 10), (2021, 10, 14), ("impish",)),
			UbuntuRelease((21, 4), (2021, 4, 22), ("hirsute",)),
	...
	(
		"Debian",
		(
			DebianRelease((12, 0), None, ("sid", "unstable")),
			DebianRelease((12, 0), None, ("bookworm", "testing")),
			DebianRelease((11, 0), None, ("bullseye", "stable")),
			DebianRelease((10, 0), (2019, 7, 6), ("buster", "oldstable")),
			DebianRelease((9, 0), (2017, 6, 17), ("stretch", "oldoldstable")),
			DebianRelease((8, 0), (2015, 4, 26), ("jessie", "oldoldoldstable")),
			DebianRelease((7, 0), (2013, 5, 4), ("wheezy", "oldoldoldoldstable")),
		),
	),
))
